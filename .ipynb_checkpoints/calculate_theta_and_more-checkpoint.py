...
#**** NOTE ****: All original matlab code is commented out
# with "!" immediately after the hash (i.e. #!...)
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
# Very useful for using with radiosonde data.
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# Input:
...
def calculate_theta_and_more(T,p,RH,varargin):
...
Theta_v = Tv.* (p_0./ p) .^(R_d/ c_p); # potential temperature.
